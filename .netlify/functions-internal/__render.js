...
<body>\r
	...
	<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TTZFTB7"\r
		...
		\r
		<section id="p5Sketch"></section>\r
		<section id="p5Sketch2"></section>\r
...
function init(settings2 = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/internal/start-8b7d67f4.js",
      css: [assets + "/internal/assets/start-61d1577b.css"],
      js: [assets + "/internal/start-8b7d67f4.js", assets + "/internal/chunks/vendor-16096c9e.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { ".svelte-kit/build/components/layout.svelte": { "entry": "layout.svelte-78c533d6.js", "css": [], "js": ["layout.svelte-78c533d6.js", "chunks/vendor-16096c9e.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-692d98c2.js", "css": [], "js": ["error.svelte-692d98c2.js", "chunks/vendor-16096c9e.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-cc81648b.js", "css": ["assets/pages/index.svelte-4a4d75a0.css", "assets/Toast-e5327f2d.css"], "js": ["pages/index.svelte-cc81648b.js", "chunks/vendor-16096c9e.js", "chunks/Toast-d952c5b7.js"], "styles": [] }, "src/routes/settings.svelte": { "entry": "pages/settings.svelte-0d7ddade.js", "css": ["assets/pages/settings.svelte-331df6f5.css", "assets/Toast-e5327f2d.css"], "js": ["pages/settings.svelte-0d7ddade.js", "chunks/vendor-16096c9e.js", "chunks/Toast-d952c5b7.js"], "styles": [] } };
...
var Input = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<section id="${"inputArea"}" class="${"svelte-1rbu9a4"}"><input id="${"textInput"}" class="${"svelte-1rbu9a4"}"${add_attribute("value", messageContent, 0)}>
	<div id="${"submit"}" class="${"svelte-1rbu9a4"}">
...
var css$5 = {
  code: "p.svelte-1gbq3y0{border:thin solid grey;border-radius:2px;padding:1em;height:min-content;margin:0 0 0.5em;width:fit-content;display:flex;flex-direction:column}.user.svelte-1gbq3y0{text-align:end;float:right;background-color:white;color:black}.theVoid.svelte-1gbq3y0{text-align:start;float:left;background-color:black;color:white}.timestamp.svelte-1gbq3y0{font-size:0.85em;text-align:right;border:none}",
  map: `{"version":3,"file":"Message.svelte","sources":["Message.svelte"],"sourcesContent":["<script lang='ts'>import { fade, fly } from 'svelte/transition';\\r\\nexport let message;\\r\\n// transition:fly='{{y:50}}'\\r\\n<\/script>\\r\\n\\r\\n<div class=\\"timestamp\\">\\r\\n\\t<span class=\\"timestamp\\">{message.timestamp}</span>\\r\\n</div>\\r\\n<p \\r\\nclass={message.sender}\\r\\n>\\r\\n{message.content}</p>\\r\\n\\r\\n<style lang='scss'>p {\\n  border: thin solid grey;\\n  border-radius: 2px;\\n  padding: 1em;\\n  height: min-content;\\n  margin: 0 0 0.5em;\\n  width: fit-content;\\n  display: flex;\\n  flex-direction: column;\\n}\\n\\n.user {\\n  text-align: end;\\n  float: right;\\n  background-color: white;\\n  color: black;\\n}\\n\\n.theVoid {\\n  text-align: start;\\n  float: left;\\n  background-color: black;\\n  color: white;\\n}\\n\\n.timestamp {\\n  font-size: 0.85em;\\n  text-align: right;\\n  border: none;\\n}</style>"],"names":[],"mappings":"AAamB,CAAC,eAAC,CAAC,AACpB,MAAM,CAAE,IAAI,CAAC,KAAK,CAAC,IAAI,CACvB,aAAa,CAAE,GAAG,CAClB,OAAO,CAAE,GAAG,CACZ,MAAM,CAAE,WAAW,CACnB,MAAM,CAAE,CAAC,CAAC,CAAC,CAAC,KAAK,CACjB,KAAK,CAAE,WAAW,CAClB,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,AACxB,CAAC,AAED,KAAK,eAAC,CAAC,AACL,UAAU,CAAE,GAAG,CACf,KAAK,CAAE,KAAK,CACZ,gBAAgB,CAAE,KAAK,CACvB,KAAK,CAAE,KAAK,AACd,CAAC,AAED,QAAQ,eAAC,CAAC,AACR,UAAU,CAAE,KAAK,CACjB,KAAK,CAAE,IAAI,CACX,gBAAgB,CAAE,KAAK,CACvB,KAAK,CAAE,KAAK,AACd,CAAC,AAED,UAAU,eAAC,CAAC,AACV,SAAS,CAAE,MAAM,CACjB,UAAU,CAAE,KAAK,CACjB,MAAM,CAAE,IAAI,AACd,CAAC"}`
};
...
var Stash = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<aside id="${"stash-component"}" class="${"svelte-1ish562"}"><div id="${"toggle-button"}" class="${"svelte-1ish562"}"><button>Chat Options
	</button></div>
${``}
</aside>`;
});
var css$3 = {
  code: "#menuButton.svelte-436n29{border:none;background:none;z-index:10}nav.svelte-436n29,button.svelte-436n29{z-index:10;position:fixed;top:2vh;right:2vw}nav.svelte-436n29{top:5vh}li.svelte-436n29{text-decoration:none;list-style:none}",
  map: `{"version":3,"file":"Menu.svelte","sources":["Menu.svelte"],"sourcesContent":["<script lang='ts'>import { fly } from 'svelte/transition';\\r\\nexport let theme = '';\\r\\nlet flyoutStatus = false;\\r\\n<\/script>\\r\\n\\r\\n<button\\r\\nid='menuButton'\\r\\non:click=\\"{() => flyoutStatus = !flyoutStatus}\\"\\r\\n><span class='material-icons'>menu</span></button>\\r\\n{#if flyoutStatus}\\r\\n<nav \\r\\ntransition:fly='{{duration: 300, x: 200}}'\\r\\nclass={theme}>\\r\\n\\t<ul>\\r\\n\\t\\t<li>\\r\\n\\t\\t\\t<a href=\\"/\\">Chat</a>\\r\\n\\t\\t</li>\\r\\n\\t\\t<li>\\r\\n\\t\\t\\t<a href=\\"/settings\\">Settings</a>\\r\\n\\t\\t</li>\\r\\n\\t</ul>\\r\\n</nav>\\r\\n{/if}\\r\\n\\r\\n<style lang=\\"scss\\">#menuButton {\\n  border: none;\\n  background: none;\\n  z-index: 10;\\n}\\n\\nnav, button {\\n  z-index: 10;\\n  position: fixed;\\n  top: 2vh;\\n  right: 2vw;\\n}\\n\\nnav {\\n  top: 5vh;\\n}\\n\\nli {\\n  text-decoration: none;\\n  list-style: none;\\n}</style>"],"names":[],"mappings":"AAwBmB,WAAW,cAAC,CAAC,AAC9B,MAAM,CAAE,IAAI,CACZ,UAAU,CAAE,IAAI,CAChB,OAAO,CAAE,EAAE,AACb,CAAC,AAED,iBAAG,CAAE,MAAM,cAAC,CAAC,AACX,OAAO,CAAE,EAAE,CACX,QAAQ,CAAE,KAAK,CACf,GAAG,CAAE,GAAG,CACR,KAAK,CAAE,GAAG,AACZ,CAAC,AAED,GAAG,cAAC,CAAC,AACH,GAAG,CAAE,GAAG,AACV,CAAC,AAED,EAAE,cAAC,CAAC,AACF,eAAe,CAAE,IAAI,CACrB,UAAU,CAAE,IAAI,AAClB,CAAC"}`
};
...
var Toast = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${(currentToastQueue == null ? void 0 : currentToastQueue.length) > 0 ? `<div class="${escape2(null_to_empty(theme)) + " svelte-1v6hbyn"}" id="${"toastContainer"}">
	${each(currentToastQueue, (toast) => `${!toasterOccupied ? `<div class="${"toastMessage svelte-1v6hbyn"}">${escape2(serveToast(toast))}
	</div>` : ``}`)}</div>` : ``}`;
});
...
var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
	...
	<main class="${escape2(null_to_empty(theme)) + " svelte-rzscfc"}"><div id="${"messages"}" class="${"svelte-rzscfc"}"><section id="${"animatedList"}" class="${"svelte-rzscfc"}">${messageList.length !== 0 ? `${each(messageList, (message) => `<span>${validate_component(Message, "Message").$$render($$result, { message }, {}, {})}
			</span>`)}` : `<p class="${"svelte-rzscfc"}">Talk to me.</p>`}</section></div>
	${validate_component(Input, "Input").$$render($$result, { messageList, timer, chatName, fileName }, {
      messageList: ($$value) => {
        messageList = $$value;
        $$settled = false;
      },
	...
	${validate_component(Stash, "Stash").$$render($$result, { messageList, chatName }, {
      messageList: ($$value) => {
        messageList = $$value;
        $$settled = false;
      },
...
var css = {
  code: "html.deep-blue{background:linear-gradient(130deg, #200338 0%, rgba(175, 0, 87, 0.1) 70%, rgba(255, 0, 247, 0) 100%), radial-gradient(circle at top, black 30%, rgba(12, 5, 94, 0.8) 60%, rgba(0, 0, 0, 0) 100%), radial-gradient(circle at bottom, #3700ff 10%, #2115a5 20%, black 40%);background-attachment:fixed}html.deep-pink{background:linear-gradient(130deg, #3a0303 0%, rgba(153, 0, 0, 0.1) 70%, rgba(255, 255, 255, 0) 100%), radial-gradient(circle at top, purple 30%, rgba(63, 5, 92, 0.8) 60%, rgba(0, 0, 0, 0) 100%), radial-gradient(circle at bottom, #b300b3 10%, #000033 30%, black 50%);background-attachment:fixed}html.soft-blue{background:linear-gradient(130deg, white 0%, rgba(255, 128, 191, 0.1) 70%, rgba(255, 0, 247, 0) 100%), radial-gradient(circle at top, #4095bf 30%, rgba(143, 134, 249, 0.8) 60%, #4095bf 100%), radial-gradient(circle at bottom, #9b80ff 10%, #2115a2 20%, white 40%);background-attachment:fixed}html.soft-pink{background:linear-gradient(130deg, white 0%, rgba(255, 128, 191, 0.1) 70%, rgba(255, 0, 247, 0) 100%), radial-gradient(circle at top, #df9fdf 30%, rgba(249, 134, 134, 0.8) 60%, #bf4040 100%), radial-gradient(circle at bottom, #ff80bf 10%, #a215a2 20%, white 40%);background-attachment:fixed}main.svelte-15l2zav{position:relative;text-align:center;padding:1em;max-width:85%;height:100%;margin:0 auto}@media(min-width: 500px){main.svelte-15l2zav{max-width:60%}}@media(min-width: 1000px){main.svelte-15l2zav{max-width:30%}}",
  map: `{"version":3,"file":"settings.svelte","sources":["settings.svelte"],"sourcesContent":["<svelte:head>\\r\\n<title>a softer space :: settings</title>\\r\\n\\r\\n<!-- <script id='p5' defer src=\\"/p5/sketch.js\\"><\/script> -->\\r\\n<!-- <script id='p5' defer src=\\"/p5/sketch2.js\\"><\/script> -->\\r\\n</svelte:head>\\r\\n\\r\\n<script lang=\\"ts\\">var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\\r\\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\\r\\n    return new (P || (P = Promise))(function (resolve, reject) {\\r\\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\\r\\n        function rejected(value) { try { step(generator[\\"throw\\"](value)); } catch (e) { reject(e); } }\\r\\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\\r\\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\\r\\n    });\\r\\n};\\r\\nimport { fade, slide } from 'svelte/transition';\\r\\nimport { bind } from 'svelte/internal';\\r\\nimport { onMount } from 'svelte';\\r\\nimport Stash from '../components/Stash.svelte';\\r\\nimport Menu from '../components/Menu.svelte';\\r\\nimport ThemeSwitcher from '../components/ThemeSwitcher.svelte';\\r\\nlet date = new Date();\\r\\nexport let theme = '';\\r\\nonMount(() => __awaiter(void 0, void 0, void 0, function* () {\\r\\n    const appStorage = window.localStorage;\\r\\n}));\\r\\n// export let name: string;\\r\\n<\/script>\\r\\n\\r\\n<Menu></Menu>\\r\\n\\r\\n<main class={theme}>\\r\\n\\t<ThemeSwitcher bind:theme></ThemeSwitcher>\\r\\n\\t<section id=\\"p5Sketch\\"></section>\\r\\n\\t<section id=\\"p5Sketch2\\"></section>\\r\\n</main>\\r\\n\\r\\n<style lang='scss'>:global(html.deep-blue) {\\n  background: linear-gradient(130deg, #200338 0%, rgba(175, 0, 87, 0.1) 70%, rgba(255, 0, 247, 0) 100%), radial-gradient(circle at top, black 30%, rgba(12, 5, 94, 0.8) 60%, rgba(0, 0, 0, 0) 100%), radial-gradient(circle at bottom, #3700ff 10%, #2115a5 20%, black 40%);\\n  background-attachment: fixed;\\n}\\n\\n:global(html.deep-pink) {\\n  background: linear-gradient(130deg, #3a0303 0%, rgba(153, 0, 0, 0.1) 70%, rgba(255, 255, 255, 0) 100%), radial-gradient(circle at top, purple 30%, rgba(63, 5, 92, 0.8) 60%, rgba(0, 0, 0, 0) 100%), radial-gradient(circle at bottom, #b300b3 10%, #000033 30%, black 50%);\\n  background-attachment: fixed;\\n}\\n\\n:global(html.soft-blue) {\\n  background: linear-gradient(130deg, white 0%, rgba(255, 128, 191, 0.1) 70%, rgba(255, 0, 247, 0) 100%), radial-gradient(circle at top, #4095bf 30%, rgba(143, 134, 249, 0.8) 60%, #4095bf 100%), radial-gradient(circle at bottom, #9b80ff 10%, #2115a2 20%, white 40%);\\n  background-attachment: fixed;\\n}\\n\\n:global(html.soft-pink) {\\n  background: linear-gradient(130deg, white 0%, rgba(255, 128, 191, 0.1) 70%, rgba(255, 0, 247, 0) 100%), radial-gradient(circle at top, #df9fdf 30%, rgba(249, 134, 134, 0.8) 60%, #bf4040 100%), radial-gradient(circle at bottom, #ff80bf 10%, #a215a2 20%, white 40%);\\n  background-attachment: fixed;\\n}\\n\\nmain {\\n  position: relative;\\n  text-align: center;\\n  padding: 1em;\\n  /* min-width: 400px; */\\n  max-width: 85%;\\n  /* width:100px; */\\n  height: 100%;\\n  margin: 0 auto;\\n}\\n\\n/* h1 {\\n\\tcolor: #fff;\\n\\ttext-transform: lowercase;\\n\\tfont-size: 3em;\\n\\tfont-weight: 600;\\n} */\\n@media (min-width: 500px) {\\n  main {\\n    max-width: 60%;\\n  }\\n}\\n@media (min-width: 1000px) {\\n  main {\\n    max-width: 30%;\\n  }\\n}</style>"],"names":[],"mappings":"AAsC2B,cAAc,AAAE,CAAC,AAC1C,UAAU,CAAE,gBAAgB,MAAM,CAAC,CAAC,OAAO,CAAC,EAAE,CAAC,CAAC,KAAK,GAAG,CAAC,CAAC,CAAC,CAAC,CAAC,EAAE,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,KAAK,GAAG,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,gBAAgB,MAAM,CAAC,EAAE,CAAC,GAAG,CAAC,CAAC,KAAK,CAAC,GAAG,CAAC,CAAC,KAAK,EAAE,CAAC,CAAC,CAAC,CAAC,CAAC,EAAE,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,gBAAgB,MAAM,CAAC,EAAE,CAAC,MAAM,CAAC,CAAC,OAAO,CAAC,GAAG,CAAC,CAAC,OAAO,CAAC,GAAG,CAAC,CAAC,KAAK,CAAC,GAAG,CAAC,CACzQ,qBAAqB,CAAE,KAAK,AAC9B,CAAC,AAEO,cAAc,AAAE,CAAC,AACvB,UAAU,CAAE,gBAAgB,MAAM,CAAC,CAAC,OAAO,CAAC,EAAE,CAAC,CAAC,KAAK,GAAG,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,KAAK,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,gBAAgB,MAAM,CAAC,EAAE,CAAC,GAAG,CAAC,CAAC,MAAM,CAAC,GAAG,CAAC,CAAC,KAAK,EAAE,CAAC,CAAC,CAAC,CAAC,CAAC,EAAE,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,gBAAgB,MAAM,CAAC,EAAE,CAAC,MAAM,CAAC,CAAC,OAAO,CAAC,GAAG,CAAC,CAAC,OAAO,CAAC,GAAG,CAAC,CAAC,KAAK,CAAC,GAAG,CAAC,CAC3Q,qBAAqB,CAAE,KAAK,AAC9B,CAAC,AAEO,cAAc,AAAE,CAAC,AACvB,UAAU,CAAE,gBAAgB,MAAM,CAAC,CAAC,KAAK,CAAC,EAAE,CAAC,CAAC,KAAK,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,KAAK,GAAG,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,gBAAgB,MAAM,CAAC,EAAE,CAAC,GAAG,CAAC,CAAC,OAAO,CAAC,GAAG,CAAC,CAAC,KAAK,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,OAAO,CAAC,IAAI,CAAC,CAAC,CAAC,gBAAgB,MAAM,CAAC,EAAE,CAAC,MAAM,CAAC,CAAC,OAAO,CAAC,GAAG,CAAC,CAAC,OAAO,CAAC,GAAG,CAAC,CAAC,KAAK,CAAC,GAAG,CAAC,CACvQ,qBAAqB,CAAE,KAAK,AAC9B,CAAC,AAEO,cAAc,AAAE,CAAC,AACvB,UAAU,CAAE,gBAAgB,MAAM,CAAC,CAAC,KAAK,CAAC,EAAE,CAAC,CAAC,KAAK,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,KAAK,GAAG,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,gBAAgB,MAAM,CAAC,EAAE,CAAC,GAAG,CAAC,CAAC,OAAO,CAAC,GAAG,CAAC,CAAC,KAAK,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,OAAO,CAAC,IAAI,CAAC,CAAC,CAAC,gBAAgB,MAAM,CAAC,EAAE,CAAC,MAAM,CAAC,CAAC,OAAO,CAAC,GAAG,CAAC,CAAC,OAAO,CAAC,GAAG,CAAC,CAAC,KAAK,CAAC,GAAG,CAAC,CACvQ,qBAAqB,CAAE,KAAK,AAC9B,CAAC,AAED,IAAI,eAAC,CAAC,AACJ,QAAQ,CAAE,QAAQ,CAClB,UAAU,CAAE,MAAM,CAClB,OAAO,CAAE,GAAG,CAEZ,SAAS,CAAE,GAAG,CAEd,MAAM,CAAE,IAAI,CACZ,MAAM,CAAE,CAAC,CAAC,IAAI,AAChB,CAAC,AAQD,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzB,IAAI,eAAC,CAAC,AACJ,SAAS,CAAE,GAAG,AAChB,CAAC,AACH,CAAC,AACD,MAAM,AAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AAC1B,IAAI,eAAC,CAAC,AACJ,SAAS,CAAE,GAAG,AAChB,CAAC,AACH,CAAC"}`
};
...
<main class="${escape2(null_to_empty(theme)) + " svelte-15l2zav"}">${validate_component(ThemeSwitcher, "ThemeSwitcher").$$render($$result, { theme }, {
      theme: ($$value) => {
        theme = $$value;
        $$settled = false;
      }
